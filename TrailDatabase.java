...
/**
 * This class sorts data from file, populates database, and handles input/output
 * @author 22yancy
 * @version 04/29/2022
 */
public class TrailDatabase {
    ...
    /**
     Imports all data out of the apptrailDB.txt
     */
    ...
    /**
     * Sorts data by searchTerm and in ascending or descending order using selection sort method
     */
